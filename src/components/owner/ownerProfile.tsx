  ...
  return (
    <div className="">
      ...
      <div className="bg-white w-full  h-5/6 flex">
        <div className="bg-gray-400 bg-opacity-20 w-[11/12] rounded-xl ml-4 md:ml-10 lg:ml-48 h-auto lg:h-[36rem] m lg:flex sm:grid">
          <div className="relative mt-4 ml-6 h-auto md:h-[34rem]  flex lg:w-[30rem] flex-col justify-between  rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
            <div className="flex  relative ml-5   mx-4 mt-6 h-56 w-72 items-center justify-center overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40">
              <img
                src="/mainImages/defalt profile image.png"
                alt="img-blur-shadow"
          ...
          <div className="w-full  md:ml-10 lg:ml-20 p-4 pt-6">
            <div className="relative flex w-full h-auto md:h-64 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
              <div className="p-6">
              ...
              <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                <div className="bg-white rounded-lg w-full max-w-md p-6">
                  ...
                  <div className="mt-3 font-extrabold">
                    From Date :{" "}
                    <span className="font-semibold">
                      {stadiumDetail?.fromdate}
                    </span>
                  </div>
                  <div className="mt-3 font-extrabold">
                    To date :{" "}
                    <span className="font-semibold">
                      {stadiumDetail?.todate}
                    </span>
                  </div>
                  <div className="mt-3 font-extrabold">
                    Price :{" "}
